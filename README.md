...
This project is **NOT** the official MFSDA_Python repository.

It is a fork of MFSDA_Python sources hosted at https://github.com/DCBIA-OrthoLab/MFSDA_Python.
...
How to update the version of MFSDA_Python ?
------------------------------------------

1. Clone this repository and add a remote to the official project

```
git clone git://github.com/slicersalt/MFSDA_Python
cd MFSDA_Python
git remote add upstream git://github.com/DCBIA-OrthoLab/MFSDA_Python
git fetch upstream
```
...
6. Update Slicer MFSDA_Python external project and submit a pull request.
